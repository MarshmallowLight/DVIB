...
class FREEDOMC(GeneralRecommender):
    def __init__(self, config, dataset):
        super(FREEDOMC, self).__init__(config, dataset)
    ...
    def calculate_loss(self, interaction):
        ...
        if self.t_feat is not None:
            ...
            noisy_text_feats = text_feats + self.noise_level * torch.randn_like(text_feats) 
        ...
        if self.v_feat is not None:
            ...
            noisy_image_feats = image_feats + self.noise_level * torch.randn_like(image_feats) 
