...
class VBPRC(GeneralRecommender):
    ...
    def forward(self, dropout=0.0):
        ...
        noisy_item_embeddings = item_embeddings + self.noise_level * torch.randn_like(item_embeddings) 
    ...
    def calculate_loss(self, interaction):
        ...
        loss = (1 - self.consistency_weight) * general_loss + self.consistency_weight * consistency_loss #NNN
        return loss
